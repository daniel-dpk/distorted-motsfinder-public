...
> D. Pook-Kolb, O. Birnholtz, B. Krishnan and E. Schnetter, "The existence and
> stability of marginally trapped surfaces." arXiv:1811.10405 [gr-qc]
...
The source code is documented in the Pythonic way using `docstrings` for
(nearly) each public function/class/method. The html documentation can be
generated using Doxygen in the root of the project:
...
An overview of how the project source is organized is also available in
[README_SRC.md](README_SRC.md).
...
sys.path.append(op.expanduser('~/src/motsfinder'))
